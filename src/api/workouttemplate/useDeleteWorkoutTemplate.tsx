...
export const useDeleteWorkoutTemplate = () => {
  ...
  return useMutation({
    ...
    onMutate: async(variables) => {
      ...
      const previousWorkoutTemplates = queryClient.getQueryData<WorkoutTemplate[]>(["AllWorkoutTemplates", userId]);

      queryClient.setQueryData(["AllWorkoutTemplates", userId], (old: WorkoutTemplate[] | undefined) => {
        if (!old) return old;
