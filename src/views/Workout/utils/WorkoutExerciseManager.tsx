        ...
        <>
            {
                 ...
                 workout.exercises.length > 0 ? <WorkoutExercisesList workoutExercises={workout.exercises} />
                :<p>Add your first exercise to the workout</p>
            }
            {showExerciseSelector===false &&<Button disabled={isPending} onClick={() => setShowExerciseSelector(true)}>Add Exercise</Button>}
            
            {showExerciseSelector && <ExerciseSelector isPending={isPending}onSelectExerciseClick={onAddSelectedExerciseClick} />}
        </>
 )
}